...
public class TrinhNgheNhacActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaiHat baiHat= (BaiHat) data.get("name");

        /*String linkAnhBH=baiHat.getHinhAnh();
        Uri uri=Uri.parse(linkAnhBH);
        ...
        if (mediaController == null) {
            mediaController = new MediaController(TrinhNgheNhacActivity.this);
        }
